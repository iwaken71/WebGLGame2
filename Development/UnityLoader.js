...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'SlowDownGL2.data';
    var REMOTE_PACKAGE_BASE = 'SlowDownGL2.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 6268368;
      var PACKAGE_UUID = '29576ae4-37b4-4df9-aa12-bebef9eb2d2b';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 2724325, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(2724325, 2724465, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(2724465, 2732683, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(2732683, 4744683, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(4744683, 6240743, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(6240743, 6268368, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_SlowDownGL2.data');

    };
    Module['addRunDependency']('datafile_SlowDownGL2.data');
